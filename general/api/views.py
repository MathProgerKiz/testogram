...
from general.api.serializers import UserRegistrationSerializer, UserListSerializer, UserRetrieveSerializer, \
    PostListSerializer, PostRetrieveSerializer, PostCreateUpdateSerializer, CommentSerializer, ReactionSerializer, \
    ChatSerializer, MessageListSerializer, ChatListSerializer
